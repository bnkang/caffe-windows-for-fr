#ifndef CAFFE_ELTWISE_AFFINE_LAYER_HPP_
#define CAFFE_ELTWISE_AFFINE_LAYER_HPP_
...
namespace caffe {
	...
	public:
		...
		*/
		explicit EltwiseAffineLayer(const LayerParameter& param) : NeuronLayer<Dtype>(param) {}
